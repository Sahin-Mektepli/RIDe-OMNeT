...
class IoTNode : public omnetpp::cSimpleModule
{
  private:
    ...
    //--rating calculation--
    double calculateRatingBenevolent (double quality, double timeliness, double rarity);
  ...
  protected:
    ...
    double calculateDecay (double currentTime,
    ...
    [[deprecated ("NO GENERAL TRUST SCORES!!")]] double trustScore = 0.5;
    bool isClusterHead;
    double potency = 0;
