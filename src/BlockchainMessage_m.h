...
public:
  ...
  virtual BlockchainTransaction *dup() const override {
    return new BlockchainTransaction(*this);
  }
...
inline void doParsimPacking(omnetpp::cCommBuffer *b,
                            const BlockchainTransaction &obj) {
  obj.parsimPack(b);
}
inline void doParsimUnpacking(omnetpp::cCommBuffer *b,
                              BlockchainTransaction &obj) {
  obj.parsimUnpack(b);
}
...
inline void doParsimPacking(omnetpp::cCommBuffer *b,
                            const ServiceRequest &obj) {
  obj.parsimPack(b);
}
inline void doParsimUnpacking(omnetpp::cCommBuffer *b, ServiceRequest &obj) {
  obj.parsimUnpack(b);
}
...
public:
  ...
  virtual ServiceResponse *dup() const override {
...
inline void doParsimPacking(omnetpp::cCommBuffer *b,
                            const ServiceResponse &obj) {
  obj.parsimPack(b);
}
inline void doParsimUnpacking(omnetpp::cCommBuffer *b, ServiceResponse &obj) {
  obj.parsimUnpack(b);
}
...
public:
  ...
  virtual FinalServiceRequest *dup() const override {
    return new FinalServiceRequest(*this);
  }
  virtual void parsimPack(omnetpp::cCommBuffer *b) const override;
  virtual void parsimUnpack(omnetpp::cCommBuffer *b) override;
...
inline void doParsimPacking(omnetpp::cCommBuffer *b,
                            const FinalServiceRequest &obj) {
  obj.parsimPack(b);
}
inline void doParsimUnpacking(omnetpp::cCommBuffer *b,
                              FinalServiceRequest &obj) {
  obj.parsimUnpack(b);
}
...
public:
  ...
  virtual FinalServiceResponse *dup() const override {
    return new FinalServiceResponse(*this);
  }
  virtual void parsimPack(omnetpp::cCommBuffer *b) const override;
  virtual void parsimUnpack(omnetpp::cCommBuffer *b) override;
...
inline void doParsimPacking(omnetpp::cCommBuffer *b,
                            const FinalServiceResponse &obj) {
  obj.parsimPack(b);
}
inline void doParsimUnpacking(omnetpp::cCommBuffer *b,
                              FinalServiceResponse &obj) {
  obj.parsimUnpack(b);
}
...
public:
  ...
  virtual ServiceRating *dup() const override {
    return new ServiceRating(*this);
  }
  virtual void parsimPack(omnetpp::cCommBuffer *b) const override;
  virtual void parsimUnpack(omnetpp::cCommBuffer *b) override;
...
inline void doParsimPacking(omnetpp::cCommBuffer *b, const ServiceRating &obj) {
  obj.parsimPack(b);
}
inline void doParsimUnpacking(omnetpp::cCommBuffer *b, ServiceRating &obj) {
  obj.parsimUnpack(b);
}

namespace omnetpp {

template <> inline BlockchainTransaction *fromAnyPtr(any_ptr ptr) {
  return check_and_cast<BlockchainTransaction *>(ptr.get<cObject>());
}
template <> inline ServiceRequest *fromAnyPtr(any_ptr ptr) {
  return check_and_cast<ServiceRequest *>(ptr.get<cObject>());
}
template <> inline ServiceResponse *fromAnyPtr(any_ptr ptr) {
  return check_and_cast<ServiceResponse *>(ptr.get<cObject>());
}
template <> inline FinalServiceRequest *fromAnyPtr(any_ptr ptr) {
  return check_and_cast<FinalServiceRequest *>(ptr.get<cObject>());
}
template <> inline FinalServiceResponse *fromAnyPtr(any_ptr ptr) {
  return check_and_cast<FinalServiceResponse *>(ptr.get<cObject>());
}
template <> inline ServiceRating *fromAnyPtr(any_ptr ptr) {
  return check_and_cast<ServiceRating *>(ptr.get<cObject>());
}
